                    ...
                    <div className="w-full grid grid-cols-1 md:grid-cols-2">
                        ...
                        <div className="w-full   px-4 flex flex-col justify-center items-center gap-3 mt-10 md:mt-0 ">
                            ...
                            <button
                                id="loginBtn"
                                type="submit"
                                className={` w-[300px] lg:w-[400px] py-3 border border-white scale-95 hover:scale-105 transition-transform duration-300 ease-in-out rounded-full mt-3 font-medium transition-all duration-300
