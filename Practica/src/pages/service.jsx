...
const servicii = [
    ...
    { id: 3, categorie: 'Preventive', nume: 'Deparazitare', descriere: 'Tratamente eficiente împotriva paraziților interni și externi.', pret: '120 MDL', icon: '🛡️', detalii: 'Deparazitare internă (viermi intestinali, Giardia) și externă (purici, căpușe, râie). Produse certificate, sigure pentru animale și familie. Recomandat la fiecare 3 luni.' },
    ...
    { id: 5, categorie: 'Chirurgicale', nume: 'Sterilizare / Castrare', descriere: 'Intervenție chirurgicală sigură pentru controlul reproducerii.', pret: 'de la 800 MDL', icon: '⚕️', detalii: 'Sub anestezie generală, cu monitorizare continuă. Include consultația pre-operatorie și îngrijirea post-operatorie. Recuperare: 7-10 zile.' },
    ...
    { id: 9, categorie: 'Grooming', nume: 'Toaletare completă', descriere: 'Baie, tuns, pieptănat și îngrijire completă a blănii.', pret: 'de la 250 MDL', icon: '✂️', detalii: 'Baie cu șampon profesional, uscare, pieptănat, tuns după rasă, curățarea urechilor, tăierea ghearelor și parfumare. Produse hipoalergenice.' },
